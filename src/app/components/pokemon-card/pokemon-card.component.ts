...
export class PokemonCardComponent {
  ...
  @Output() saveCard: EventEmitter<{ name: string; card: PokemonCard }> =
    new EventEmitter<{ name: string; card: PokemonCard }>();
  @Output() removeCard: EventEmitter<{ name: string; card: PokemonCard }> =
    new EventEmitter<{ name: string; card: PokemonCard }>();
